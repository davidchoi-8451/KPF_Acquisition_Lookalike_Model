...
Using KPF-specific data and features that more closely tie in with KPF business knowledge, 1. Create a binary classification model that distinguishes a potential 3P Gift HH from a non-gifting HH.
